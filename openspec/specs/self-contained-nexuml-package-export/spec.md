# self-contained-nexuml-package-export Specification

## Purpose

Ensure exported NexuML pipelines carry framework, library, and custom source code while keeping heavyweight dependencies external.
