# exported-runtime-dependency-manifest Specification

## Purpose

Describe exact external runtime dependencies required by exported packages so clean environments can install and diagnose them.
