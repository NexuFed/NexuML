# exported-checkpoint-provenance Specification

## Purpose

Preserve checkpoint files, normalized metadata, and training state so exported models can resume downstream training.
